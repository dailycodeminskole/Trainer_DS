...
HINT : convert the list into set
...
3. use update() to update fruits with more_fruits
fruits = {"apple", "banana", "cherry"}
more_fruits = ["orange", "kiwi", "banana"]

4. use a for loop to iterate over the elements in a set
fruits = {"apple", "banana", "cherry"}
