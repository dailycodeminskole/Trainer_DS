...
# HW
'''
1. using for loop print all the element in the list 
fruits = ['apple', 'banana', 'orange', 'mango', 'kiwi', 'pineapple']

2. using for loop take cube of  all the element in the list
list_two = [1,11,111,1111]

3. using range() generate list containing table of 9
Hint [9,18,27.....90]
